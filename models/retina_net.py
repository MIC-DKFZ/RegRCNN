...
class net(nn.Module):
    ...
    def train_forward(self, batch, is_validation=False):
        ...
        for b in range(img.shape[0]):
            ...
            #self.debug_acm.append(anchor_class_match[anchor_class_match>0].data.cpu().numpy())
            #print("anchor_c matches:", anchor_class_match.unique())
        ...
        if self.cf.model == 'retina_unet':
            ...
            #                 "mean pixel preds: {5:.5f}".format(loss.item(), batch_class_loss.item(), batch_bbox_loss.item(),
            ...
            #    loss.item(), batch_class_loss.item(), batch_bbox_loss.item()))
